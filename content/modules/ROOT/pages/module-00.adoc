...
[NOTE]
====
**Terminology Note**: Red Hat has recently consolidated its AI-powered services under new branding. Throughout Labs 1-3, you will see references to **Ansible Lightspeed** — this technology is now called **Automation code assistant** and supports multiple AI backends (Gemini, Red Hat AI, or IBM watsonx). Similarly, **Red Hat Insights** on console.redhat.com is now branded as **Red Hat Lightspeed**. The functionality is the same — only the names have changed. You will work with the new naming in Labs 4 and 5.
====
