...
You've completed Part 2! Ready to extend the AIOps pattern to Windows? Continue to Part 3 to see how Event-Driven Ansible detects Windows security events and automatically creates AI-enriched tickets.

xref:module-06.adoc[Next: Part 3 - Windows Event-Driven Automation ->]
