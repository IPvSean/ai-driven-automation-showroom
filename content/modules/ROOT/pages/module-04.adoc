...
[NOTE]
====
**Terminology reminder**: References to "Ansible Lightspeed" in this section refer to the technology now called **Automation Code Assistant**. See the note in Section 1 for full details on the naming update.
====
