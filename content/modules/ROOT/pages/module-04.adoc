= Module 2.3 — Network Workflow

[NOTE]
====
**Terminology reminder**: References to "Ansible Lightspeed" in this section refer to the technology now called **Automation code assistant**. See the note in Module 1.1 for full details on the naming update.
====
...
You have successfully completed the Network Automation portion of this lab! You've now seen how AI-driven automation can be applied to both server infrastructure (Lab 1) and network infrastructure (Lab 2).

== What's Next?

You've completed Lab 2! Ready to extend the AIOps pattern to Windows? Continue to Lab 3 to see how Event-Driven Ansible detects Windows security events and automatically creates AI-enriched tickets.

xref:module-06.adoc[Next: Lab 3 - Windows Event-Driven Automation ->]

Or skip directly to the summary:

xref:module-05.adoc[Summary and Call to Actions ->]

== Complete

Click the link above to proceed to the next section.
