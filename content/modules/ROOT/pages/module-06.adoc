= Module 3.1 — Windows Events and AI-Driven Ticketing
...
This use case follows the same AIOps pattern as Labs 1 and 2 but applies it to the Windows ecosystem, showing how event-driven automation is platform-agnostic.
...
You have completed Module 3.1 — Windows Event-Driven Automation! Continue to the summary section to review all the concepts you've learned across all labs of this workshop.

xref:module-05.adoc[Next: Summary and Call to Actions ->]
