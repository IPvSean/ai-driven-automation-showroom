= Section 3 - Windows Events and AI-Driven Ticketing
...
== 3 - Challenge 1: AD account creation event
...
=== Step 3.1.1: Verify EDA rulebook is active
...
=== Step 3.1.2: Simulate AD account creation
...
=== Step 3.1.3: Observe EDA response
...
=== Step 3.1.4: View the Mattermost ticket
...
== 3 - Challenge 2: Firewall event with AI enrichment
...
=== Step 3.2.1: Simulate Windows Firewall toggle
...
=== Step 3.2.2: Observe EDA response
...
=== Step 3.2.3: Watch the AI analysis
...
=== Step 3.2.4: View the AI-enriched ticket
