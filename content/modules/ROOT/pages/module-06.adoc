...
You have completed Module 3.1 — Windows Event-Driven Automation! Continue to the summary section to review all the concepts you've learned across all parts of this workshop.
