= Section 1.2 - Remediation Workflow

== Objective

For this section, we will build another workflow called the **Remediation Workflow**. The goal for this workflow is to take the information we learned from Section 1 with Red Hat AI and now prompt Automation coding assistant to automatically create an Ansible Playbook to fix the issue. By combining these two workflows, we can create an AIOps workflow capable of self-healing infrastructure.

image::remediation_workflow.png[remediation_workflow, link="_images/remediation_workflow.png", window=blank]
...
* Build a remediation workflow using AI-generated prompts
* Use Automation coding assistant to automatically generate remediation playbooks
* Commit AI-generated playbooks to source control (Gitea)
* Review and validate AI-generated automation code before execution
* Execute automated remediation to fix service failures
...
image::remediation_workflow_list.png[create_workflow, link="_images/remediation_workflow_list.png", window=blank]
...
image::view_workflow_visualizer_button.png[visualizer_button,300, link="_images/view_workflow_visualizer_button.png", window=blank]
...
image::add_step_lightspeed_remediation.png[add_step_lightspeed_remediation,500, link="_images/add_step_lightspeed_remediation.png", window=blank]
...
image::remediation_workflow_part_one.png[remediation_workflow_part_one,500, link="_images/remediation_workflow_part_one.png", window=blank]
...
image::remediation_workflow_part_two.png[remediation_workflow_part_two,500, link="_images/remediation_workflow_part_two.png", window=blank]
...
image::remediation_workflow_part_two_final.png[remediation_workflow_part_two_final,500, link="_images/remediation_workflow_part_two_final.png", window=blank]
...
image::remediation_workflow_part_three.png[remediation_workflow_part_three,500, link="_images/remediation_workflow_part_three.png", window=blank]

[quote]
⚠️ Notice this node type is different.  This is a *built-in* node type that will force a **Project Sync** to the repository that will hold our auto-generated Ansible Playbooks.  This is effectively a *git pull*  The previous node: *🧾 Commit Fix to Gitea*  synced the Ansible Playbook from Automation coding assistant to Gitea, now we are retrieving that playbook from Gitea to use in Ansible Automation Platform.
...
image::remediation_workflow_part_three_final.png[remediation_workflow_part_three_final,500, link="_images/remediation_workflow_part_three_final.png", window=blank]
...
image::remediation_workflow_part_four.png[remediation_workflow_part_four,500, link="_images/remediation_workflow_part_four.png", window=blank]
...
image::remediation_workflow_part_four_final.png[remediation_workflow_part_four_final,500, link="_images/remediation_workflow_part_four_final.png", window=blank]
...
image::save_button.png[save_button,150, link="_images/save_button.png", window=blank]

=== Verify workflow structure

Before launching the workflow, confirm it's built correctly:

✅ **Expected result:**

* Workflow named "Remediation Workflow" exists
* Workflow contains 4 nodes in sequence:
  1. 🧠 Lightspeed Remediation Playbook Generator
  2. 🧾 Commit Fix to Gitea
  3. Lightspeed-Playbooks (Project Sync)
  4. ⚙️ Build HTTPD Remediation Template
* All nodes connected with "Run on success"
* Workflow is saved and ready to execute
...
image::launch_template_button.png[launch_template_button,150, link="_images/launch_template_button.png", window=blank]

[quote]
💡 This is the really cool part!  A survey prompt will appear with two text boxes side-by-side:

* **Left text box (required field with red asterisk *)**: This is where you enter the prompt that will be sent to Automation coding assistant to generate the remediation playbook. This field is currently pre-populated with a manually crafted prompt created by the Ansible Tech Marketing team.
...
image::workflow_prompt.png[workflow_prompt, link="_images/workflow_prompt.png", window=blank]
...
[quote]
💡 **Why this matters**: This step allows you to course-correct any output that AI has provided. You can review what the AI suggests before prompting Automation coding assistant, ensuring the prompt is accurate and appropriate for your environment. This human-in-the-loop validation is a best practice for AI-driven automation.
...
image::remediation_workflow_success.png[remediation_workflow_success,150, link="_images/remediation_workflow_success.png", window=blank]
...
* Use that prompt to call Automation coding assistant
* Automation coding assistant generated an Ansible Playbook to fix the issue
...
3. Review the most recent commits — you should see one that corresponds to the AI-generated fix.
...
image::limit_node1.png[limit_node1,300, link="_images/limit_node1.png", window=blank]
...
image::aiops-cool.gif[aiops-cool, link="_images/aiops-cool.gif", window=blank]

'''

== 🎉 Congratulations! You've Completed Part 1!

You have successfully completed the **basic introduction** to AIOps! You've experienced firsthand how **Red Hat AI**, **Automation coding assistant**, and **Ansible Automation Platform** can work together to create intelligent, self-healing infrastructure.

=== What You Accomplished

* ✅ Built an AI-powered log enrichment workflow
* ✅ Used Red Hat AI to analyze incidents and generate insights
* ✅ Used Automation coding assistant to automatically create remediation playbooks
* ✅ Fixed a broken Apache service without writing a single line of playbook code

'''

== ⭐ Ready for More? Part 2 Awaits!
...
* 🔍 **Splunk** for network observability and alerting
* 📡 **Event-Driven Ansible** responding to OSPF routing issues
* 🧠 **Automation coding assistant** generating network remediation playbooks
* 🌐 **Cisco routers** with OSPF configuration challenges
