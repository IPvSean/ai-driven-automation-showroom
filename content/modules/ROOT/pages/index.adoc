...
This workshop consists of three independent parts:
...
Same pattern, different observability tools and domains.
...
[TIP]
====
**Choose your path:** All three parts are independent and can be completed in any order. New to AIOps? Start with Part 1. Already familiar with the basics? Jump to Part 2 for network automation or Part 3 for Windows event-driven automation.
====
