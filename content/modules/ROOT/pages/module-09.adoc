...
image::crond_status_invalid_user_errors.png[crond showing repeated getpwnam errors, link="_images/crond_status_invalid_user_errors.png", window=blank]
...
Source: link:https://github.com/ansible-tmm/aiops-summitlab/blob/feat/rhel-self-healing/playbooks/fix_cron_permissions.yml[fix_cron_permissions.yml on GitHub^]
