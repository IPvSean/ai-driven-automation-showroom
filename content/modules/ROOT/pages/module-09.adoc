...
image::crond_status_healthy.png[crond service healthy and running on node1, link="_images/crond_status_healthy.png", window=blank]
...
1. Navigate to **Automation Execution** -> **Templates**
+
image::break_cron_bad_syntax_template.png[Templates navigation, link="_images/break_cron_bad_syntax_template.png", window=blank]
+
2. Find **Break Cron - Invalid User** and click the launch icon
+
image::break_cron_invalid_user_template.png[Break Cron - Invalid User template, link="_images/break_cron_invalid_user_template.png", window=blank]
+
3. Set the **Limit** to `node1` (same as Challenge 1), then click **Next** and **Finish**
+
image::cron_aiops_launch_limit.png[Set Limit to node1, link="_images/cron_aiops_launch_limit.png", window=blank]
+
4. Wait for the job to complete
...
image::cron_aiops_workflow_running.png[Cron-AIOps-Workflow running, link="_images/cron_aiops_workflow_running.png", window=blank]
...
+
image::aap_notification_bell.png[AAP notification bell showing pending approval, link="_images/aap_notification_bell.png", window=blank]
